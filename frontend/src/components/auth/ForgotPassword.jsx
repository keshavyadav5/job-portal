        ...
        <div className='flex-1 flex items-center justify-center p-4'>
          <div className='w-full max-w-md space-y-6'>
            <div className='text-center space-y-2'>
              <h1 className='text-3xl font-bold tracking-tight text-purple-600'>Reset Your password</h1>
            ...
            <Card className='bg-white'>
              <CardHeader className='space-y-1'>
                <CardTitle className='text-2xl text-center text-purple-600'>Forgot Password</CardTitle>
                ...
                }
                {
                  isSubmitted ? (
                    ...
                    <form onSubmit={handleForgotPassword} className='space-y-4'>
                      ...
                      <Button className="w-full bg-purple-600 text-white relative hover:bg-purple-500 cursor-pointer">
                        {
                          isLoading ? (
                            <>
              ...
              <CardFooter className='flex justify-center'>
                <p>
                  ...
                  <Link to={'/login'} className='text-purple-600 hover:underline font-medium relative'>Sign in</Link>
                </p>
              </CardFooter>
            </Card>
          </div>
